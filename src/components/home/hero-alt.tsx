        ...
        <div className="max-w-xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link
              ...
              className="group bg-none text-primary px-8 py-4 flex items-center transition-colors duration-300 hover:cursor-pointer"
            >
            ...
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group bg-primary hover:bg-[#2A2752] text-white px-8 py-4 flex items-center transition-colors duration-300 hover:cursor-pointer"
            >
              <span className="text-sm font-medium tracking-widest uppercase mr-4">
                Register Now
              </span>
